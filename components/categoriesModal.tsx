...
export default function CategoriesModal({data, onSuccess, onSave}: ModalProps) {
      ...
      <DialogHeader>
        ...
        <div className="grid my-4 gap-3">
            <Field key={'title'} className="gap-1">
              ...
              <FieldContent>
                <Input required name="title" defaultValue={data ? data.title : ''} placeholder="Insert the title"/>
              </FieldContent>
            </Field>
            <Field key={'desc'} className="gap-1">
              <FieldLabel>Description</FieldLabel>
              <FieldContent>
                <Input required name="desc" defaultValue={data ? data.desc : ''} placeholder="Insert the description"/>
              </FieldContent>
            </Field>
            <Field key={'img'} className="gap-1">
              <FieldLabel>Image URL</FieldLabel>
              <FieldContent>
                <Input required name="img" defaultValue={data ? data.img : ''} placeholder="Insert the image url"/>
              </FieldContent>
            </Field>
        </div>
