    ...
    return (
        ...
        <Sidebar>
          <SidebarHeader className="bg-[#3eb2b4]">
            ...
            <div className="flex justify-end"><Badge className="text-[#3eb2b4] bg-white">Admin</Badge></div>
          </SidebarHeader>
            <SidebarContent >
            <SidebarGroup>
                ...
                <Link href={"/orders"} className={`py-3 ${pathname === "/orders" ? "text-[#FDBB2D]" : "text-black"} hover:text-[#FDBB2D]`}>
                    ...
                    <h6 className="text-gray-500 text-sm px-3">List all the orders</h6>
                </Link>
            </SidebarGroup>
          </SidebarContent>
          <SidebarFooter className="flex flex-row items-center justify-start px-3 text-sm mb-2">
            <Avatar>
                <AvatarImage className="border-2 border-[#3eb2b4] rounded-4xl" src="https://tse1.explicit.bing.net/th/id/OIP.0VUlY37k8_RL1FKov9zD9gHaHa?pid=ImgDet&w=184&h=184&c=7&dpr=1.3&o=7&rm=3" />
            ...
            <TooltipTrigger asChild>
                <Button className="ml-10" variant="ghost"><LogOut /></Button>
            </TooltipTrigger>
            <TooltipContent>
                <p>Log out</p>
            </TooltipContent>
